...
export default function PlaylistScreen(props: NativeStackScreenProps<RootStackParamList, 'Playlist'>) {
  ...
  const renderVideoItem = ({ item, index }: any) => {
    ...
    return (
      <TouchableOpacity onPress={() => handleVideoSelection(index)} style={styles.videoItem}>
